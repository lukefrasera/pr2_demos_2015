...
void protobuf_AssignDesc_points_2eproto() {
  ...
  Points_descriptor_ = file->message_type(0);
  static const int Points_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Points, points_),
  };
  Points_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      Points_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Points, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Points, _unknown_fields_),
      -1,
...
Points::Points()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:Points)
}
...
Points::Points(const Points& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Points)
}
...
Points::~Points() {
  // @@protoc_insertion_point(destructor:Points)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Points)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Points)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Points)
  return false;
#undef DO_
}
...
void Points::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Points)
  // repeated .Point points = 1;
  ...
  // @@protoc_insertion_point(serialize_end:Points)
}

::google::protobuf::uint8* Points::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Points)
  // repeated .Point points = 1;
  for (int i = 0; i < this->points_size(); i++) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Points)
  return target;
}
...
void Points::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const Points* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const Points*>(
      &from);
  if (source == NULL) {
